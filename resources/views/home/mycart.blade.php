...
@php
    // Calculate total value before displaying buttons
    $value = 0;
    foreach ($cart as $c) {
        $value += $c->product->price;   //  $value = $value  + $c->product->price;
        ...
        <table>
            ...
            @foreach ($cart as $cart)
                <tr>
                    ...
                    <td>
                        <img width="150" src="{{ asset('products/' . $cart->product->image) }}">
                    </td>
    ...
    <div class="cart_value">
        ...
        <h3>Total Value of Cart is : ${{$value}}</h3>
            ...
            <form action="{{ url('comfirm_order') }}" method="POST">
                ...
                <div class="div_gap">
                    <label>Receiver Address</Address></label>
                ...
                <div class="div_gap">
                    ...
                    <a href="{{ url('stripe?amount=' . $value) }}" class="btn btn-success">
                        Pay Using Card 
                    </a>
