...
//custom routes for admin - v1 routes
route::get('admin/dashboard', [HomeController::class, 'index'])->middleware(['auth', 'admin']);
route::get('admin/category', [AdminHomeController::class, 'view_category'])->middleware(['auth', 'admin']);
...
//admin/category === category  ( ->name('category_page');)
